...
class SearchStaggeredGrid extends StatefulWidget {
  const SearchStaggeredGrid({super.key});

  @override
  State<SearchStaggeredGrid> createState() => _SearchStaggeredGridState();
}

class _SearchStaggeredGridState extends State<SearchStaggeredGrid> {
        ...
        children: [
          ...imgList.asMap().entries.map(
                (entry) => StaggeredGridTile.count(
                    ...
                    mainAxisCellCount: entry.key % 10 == 0 ? 2 : 1,
